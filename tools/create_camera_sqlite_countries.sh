...
Info () {
    ...
    printf "For example:  \"./create_camera_sqlite_countries.sh EU\" or \"./create_camera_sqlite_countries.sh eu\"\n\n"
...
Create_Databases() {
    ...
    do
        ...
        ./build_camera_db.py --continent $CONTINENT -o $country
    done
}
...
Create_Single_Country_Database() {
    ...
    for list in EU AS CAM NAM SAM AF; do
        if echo "${!list}" | tr ' ' '\n' | grep -qx "$country"; then
            ...
            case $list in
                "EU" | "eu")
                    ./build_camera_db.py --continent europe -o $country;;
                "AS" | "as")
                   ./build_camera_db.py --continent asia $country;;
                "CAM" | "cam")
                   ./build_camera_db.py --continent central-america $country;;
                "NAM" | "nam")
                   ./build_camera_db.py --continent north-america $country;;
                "SAM" | "sam")
                   ./build_camera_db.py --continent south-america $country;;
                "AF" | "af")
                   ./build_camera_db.py --continent africa $country;;
                *) 
