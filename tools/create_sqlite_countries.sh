...
Create_Databases() {
    ...
    do
        ...
        ./max_speed_db_cli.py --continent $CONTINENT -o $country
    done
}
        ...
        if echo "${!list}" | tr ' ' '\n' | grep -qx "$country"; then
            ...
            case $list in
                "EU" | "eu" | "EU_A" | "eu_a" | "EU_B" | "eu_b")
                    ./max_speed_db_cli.py --continent europe -o $country;;
                "AS" | "as")
                   ./max_speed_db_cli.py --continent asia $country;;
                "CAM" | "cam")
                   ./max_speed_db_cli.py --continent central-america $country;;
                "NAM" | "nam")
